...
- 一旦利率上升，則所有在未來才能帶來現金流的資產的 PV 都會下降（在[[5 - 債券的定價|評價債券]]時也會用到這個概念）
- 由於 $i$ 是[[3 - Money Growth & Inflation#Fisher Effect|名目利率]]，已經有考慮到通膨率，所以通膨率不會影響 PV

>其實所有的金融商品評價，都是在計算 PV。

>[!Note]
>關於 present value 的完整介紹，請見[[4 - 現金流量折現|本文]]。
